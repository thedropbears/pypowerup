...
class Robot(magicbot.MagicRobot):
    ...
    def createObjects(self):
        ...
        self.module_a = SwerveModule(  # top left module
            ...
            steer_enc_offset=-3854, x_pos=0.3, y_pos=0.3,
